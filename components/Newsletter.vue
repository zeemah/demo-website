...
">
  <div class=" p-10  py-20  flex  flex-col  flex-wrap  justify-center  content-center">
    <div class=" m-0  p-0  text-3xl  text-white  antialiased  text-center text-4xl font-semibold pb-8">Get Our Updates</div>
    ...
    <div class=" mt-3  flex  flex-row  flex-wrap">
      <input type="text" class=" text-gray-600  w-2/3  p-2 pl-4  rounded-l-lg" placeholder="name@mail.com"/>
      <button class=" p-2  w-1/3 bg-green-700  rounded-r-lg  text-white hover:bg-gray-600 hover:text-white" type="button">Subscribe</button>
    </div>
  </div>
</div>
</template>