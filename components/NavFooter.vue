    ...
    <!-- <div class="mb-16"> -->
        <footer class="text-gray-600 body-font bg-gray-700">
            ...
            <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                ...
                <span class="ml-3 text-xl text-white">OUR STORY</span>
                </a>
                <p class="mt-2 text-sm text-white">Lorem ipsum dolor sit amet. Proin gravida nibh vel velit auctor aliquet. 
                    Aeneansollicitudin, lorem quis bibendum auctonisi elit consequat lorem ipsum.</p>
            </div>
            ...
            <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                ...
                <a href="#" rel="noopener noreferrer" class="text-gray-400 ml-1" target="_blank">inertia </a>
                </p>
